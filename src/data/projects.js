...
const baseProjects = [
  ...
  },
  {
    ...
    mediaLabel: "CAMPAIGN MOTION / 9:12",
    tone: "coral",
    sections: [
      {
        title: "项目背景",
        body: "交代活动主题、传播目标、目标人群、渠道和上线时间窗口。",
        prompt: "活动 brief、品牌限制和团队分工",
      },
      {
        title: "设计挑战",
...
export const projects = baseProjects.map((project) => (
  portfolioCases[project.slug]
    ? { ...project, ...portfolioCases[project.slug], index: project.index }
    : project
));
...
export const projectGalleryItems = [
  {
    slug: "consumer",
    label: "C 端产品",
    status: "AI 健康管家一站式服务平台",
    image: "/portfolio/consumer/boards/frame-01.webp",
    alt: "AI 健康管家一站式服务平台封面",
    link: "/work/consumer",
  },
  {
    slug: "enterprise",
  ...
  },
  {
    ...
    label: "H5 运营活动",
    status: "COMING SOON",
    image: "/portfolio/placeholders/h5.svg",
    alt: "H5 运营活动项目占位视觉",
  },
  {
    slug: "ai-product",
